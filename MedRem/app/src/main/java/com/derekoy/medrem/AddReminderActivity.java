...
import com.derekoy.medrem.data.AlarmReminderContract;
import com.derekoy.medrem.reminder.AlarmScheduler;
...
public class AddReminderActivity extends AppCompatActivity implements
    ...
    private Switch mRepeatSwitch, mHungry;
    ...
    private static final String KEY_HUNGRY = "hungry_key";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // mHungryStatus = (Switch) findViewById(R.id.ac_tok);
       ...
       //Başlığın girişi
        ...
        mRepeatText.setText("Her " + mRepeatNo + " " + mRepeatType );
        ...
        if (savedInstanceState != null) {
            ...
            // mHungry = savedInstanceState.getString(KEY_HUNGRY);
        }

 // Aktif butonları görüntüleme
    ...
    public void setTime(View v){
        if(mCurrentReminderUri == null){
            Toast.makeText(this, "Saati tekrar seçiniz.", Toast.LENGTH_LONG).show();
            return;
        }
    ...
    public void setDate(View v){
        if(mCurrentReminderUri == null){
            Toast.makeText(this, "Tarihi tekrar seçiniz.", Toast.LENGTH_LONG).show();
            return;
        }
        Calendar now = Calendar.getInstance();
    ...
    // Alarm aktif butonuna basıldıgında
    ...
    /* public void onHungrySet(View view){
        boolean on = ((Switch) view).isChecked();
        if (on) {
            setTextTitle.description(description + " Yemekten sonra ilacınızı alınız.")
        }
        if(of) {
            setTextTitle.description(description + " Yemekten önce ilacınızı alınız.")
            }
    } */

    // Tekrar switchine basıldıgında
    ...
    public void selectRepeatType(View v){
        ...
        //List Diaolg oluşturulması
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("Tipini seçiniz.");
    ...
    //Tekrar süresi girilirken
    public void setRepeatNo(View v){
        AlertDialog.Builder alert = new AlertDialog.Builder(this);
        alert.setTitle("Zaman giriniz.");
 ...
 // menu itemlerini yuklemek içn
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        // yeni görevse delete ikonunu sakla
        if (mCurrentReminderUri == null) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.save_reminder:
                ...
                if (mTitleText.getText().toString().length() == 0){
                    mTitleText.setError("Boş bırakılamaz!");
                }
            ...
            case R.id.discard_reminder:
                // Silerken sormak içni dialog oluşturma
                showDeleteConfirmationDialog();
                return true;
            // geri tuşu
            case android.R.id.home:

                // değişim yoksa main.activitye dön
                if (!mVehicleHasChanged) {
                    NavUtils.navigateUpFromSameTask(AddReminderActivity.this);
                    return true;
                }

                //kaydedilmemiş degisiklik için kullanıcıya sor
    ...
    private void showUnsavedChangesDialog(
            DialogInterface.OnClickListener discardButtonClickListener) {
        //kaydedilmeyen değişiklikler için dialog
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
  ...
  //kaydet butonuna basıldıgında
    public void saveReminder(){
        ...
        // values.put(AlarmReminderContract.AlarmReminderEntry.KEY_HUNGRY, mHungry);
        ...
        if (mRepeatType.equals("Dakika")) {
            mRepeatTime = Integer.parseInt(mRepeatNo) * milMinute;
        } else if (mRepeatType.equals("Saat")) {
            mRepeatTime = Integer.parseInt(mRepeatNo) * milHour;
        } else if (mRepeatType.equals("Gün")) {
            mRepeatTime = Integer.parseInt(mRepeatNo) * milDay;
        } else if (mRepeatType.equals("Hafta")) {
            mRepeatTime = Integer.parseInt(mRepeatNo) * milWeek;
        } else if (mRepeatType.equals("Ay")) {
            mRepeatTime = Integer.parseInt(mRepeatNo) * milMonth;
        }

        if (mCurrentReminderUri == null) {
// yeni görevi uri ile provider'a bildir.
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        // Content providerin query metodu arka planda çalıştırılır.
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        //cursor ile verileri ilk veriden itibaren okuma
        ...
        if (cursor.moveToFirst()) {
            ...
            mRepeatText.setText("Her " + repeatNo + " " + repeatType );
