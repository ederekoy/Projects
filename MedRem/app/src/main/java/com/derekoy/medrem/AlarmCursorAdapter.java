...
public class AlarmCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        //int hungryColumnIndex = cursor.getColumnIndex(AlarmReminderContract.AlarmReminderEntry.KEY_HUNGRY);
        ...
        if(repeat != null){
            ...
            mRepeatInfoText.setText("Tekrar ayarlanmadı.");
        }
    ...
    public void setReminderTitle(String title) {
        ...
        //Rasgele renklerde yuvarlaklar oluşturma
    ...
    public void setReminderRepeatInfo(String repeat, String repeatNo, String repeatType) {
        if(repeat.equals("true")){
            mRepeatInfoText.setText("Her " + repeatNo + " " + repeatType);
        }else if (repeat.equals("false")) {
            mRepeatInfoText.setText("Tekrar Kapalı");
        }
    }

    // Alarm aktif inaktif resmi
